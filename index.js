...
function sortStocksOnPriceLowToHigh(stock1, stock2) {
  return stock1.price - stock2.price;
}

function sortStocksOnPriceHighToLow(stock1, stock2) {
...
app.get('/stocks/sort/pricing', (req, res) => {
  ...
  if (pricing.toLowerCase() == 'low-to-high') {
    result = stocksData.sort(sortStocksOnPriceLowToHigh);
...
function sortStocksOnGrowthHighToLow(stock1, stock2) {
...
app.get('/stocks/sort/growth', (req, res) => {
  ...
  if (growth.toLowerCase() == 'low-to-high') {
    result = stocksData.sort(sortStocksOnGrowthLowToHigh);
  } else if (growth.toLowerCase() == 'high-to-low') {
